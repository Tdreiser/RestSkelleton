...
insert into cars (mark,model,manufactureyear)
values('toyota','mark-II',1993);
insert into cars (mark,model,manufactureyear)
values('lada','2101',2023);
insert into cars (mark,model,manufactureyear)
values('lamborgini','muercilado',2019);
...
insert into clients (email,name,phone,car_id)
values('loma@email.com','loma','+712093812',2);
insert into clients (email,name,phone,car_id)
values('spam@email.com','spam','+712412551',3);